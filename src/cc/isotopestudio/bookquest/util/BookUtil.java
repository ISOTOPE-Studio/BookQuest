...
/*
 * From https://www.spigotmc.org/threads/open-book-gui.131470/
 */


import cc.isotopestudio.bookquest.util.ReflectionUtils.PackageType;
    ...
    public static void setPages(BookMeta metadata, List<String> pages) {
        ...
        try {
            ...
            for (String text : pages) {
                page = ReflectionUtils.invokeMethod(PackageType.MINECRAFT_SERVER.getClass("IChatBaseComponent$ChatSerializer").newInstance(), "a", text);
                p.add(page);
            }
        } catch (Exception e) {
            e.printStackTrace();
